...
# this is so that we can just say "create a new board object", ore
...
class Board:
    ...
    def make_new_board(self):
        ...
        # but since we have a 2-0 board, list of lists is more natural
        ...
        while bombs_planted < self.num_bombs:
            loc = random.randint(0, self.dim_size**2 - 1)  # return a random number integer N such that a<=N <=b
            row = loc // self.dim_size
            col = loc % self.dim_size

            if board[row][col] =='*':
                # this means we've actually planted a bomb already so keep going
                continue
    ...
    def __str__(self):
        ...
        # first let's create a new array that represents what the use would see
