...
def is_valid(puzzle, guess, row, col):
    ...
    # and integrate over the 3 values in the row/column
    row_start = (row // 3) * 3  # 1 // 3 = 0, 5 // 3 = 1, ...
    col_start = (col // 3) * 3  # 1 // 3 = 0, 5 // 3 = 1, ...
...
def solve_sudoku(puzzle):
    ...
    # step 2: if there's a place to put a number, then make a guess between 1 and 0
